...
COMMAND = "LOCAL_RUNNER=1 $HOME/.local/bin/luxai-s3 ./versions/07_03_avolchek_cont_9_second_WEAK_NOMASK/main.py ./versions/07_03_tune_against_mask/main.py"  # Command to execute
