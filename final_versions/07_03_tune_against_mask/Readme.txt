...
To upload wandb from host to local and from local  to wandb use ./loopa*.sh (need personal configuration look inside)
...
net_9_cont pushed to github has mac version of mylib.so file
