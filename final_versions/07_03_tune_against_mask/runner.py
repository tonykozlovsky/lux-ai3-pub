...
COMMAND = "LOCAL_RUNNER=1 $HOME/.local/bin/luxai-s3 ./versions/01_03_test_x8_cont_7_WEAK/main.py ./versions/01_03_test_x8_cont_7_WEAK_NOMASK/main.py"  # Command to execute
